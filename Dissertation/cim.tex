...
и обязательным аттрибутом \texttt{value} (см. листинг \ref{lst:modbus_tags_scenario_configs}).
Также есть ряд необязательных аттрибутов, о которых будет сказано отдельно. 
