class ModbusGuardedWriter : public IModbusElementWriterImpl {
protected:
    // ...
    [[nodiscard]] bool conditionsMet(const modbusio::ModbusData& data) override {
        return _condition==data && modbusio::Comparator::compare(_condition, data);
    }

class Comparator final {
public:
    [[nodiscard]] static bool compare(const modbusio::ModbusDataRelationed& cond, const modbusio::ModbusData& data)
    {
