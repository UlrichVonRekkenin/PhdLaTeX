% Запретить перенос слов, начинающихся с заглавной буквы.
% Значение по умолчанию 1
\uchyph=0

% Значение по умолчанию 10.
% Увеличить количество столбцов в матрице.
...
\lstset{ %
    language=C++,                     %  Язык указать здесь, если во всех листингах преимущественно один язык, в результате часть настроек может пойти только для этого языка
...
{%
    ...
    keywordstyle=\color{lightblue}\textmd,
}
