...
для объектов контроля, критичным к ошибкам\ldots

Для~достижения поставленной цели необходимо было решить следующие {\tasks}:
\begin{enumerate}
  \item Проанализировать имеющееся программное обеспечение на рынке или в виде свободнораспростроняемого.
  \item Определить параметры имитационной модели.
  \item Создать программное обеспечение для имитационной модели.
\end{enumerate}
...
{\reliability} полученных результатов обеспечивается \ldots \ Результаты находятся в соответствии с результатами,
